          ...
          <div className="content ">
            <div className="columns is-centered">
              <div className="column">
                <h1 style={{fontSize: '2.75rem'}}><FontAwesomeIcon icon={['fab', 'sketch']} /><span>&nbsp;&nbsp;<FontAwesomeIcon icon={['far', 'pencil-ruler']} /></span><span>&nbsp;&nbsp;<FontAwesomeIcon icon={['fab', 'fort-awesome']} /></span></h1>
              ...
              <div className="column">
               <h1 style={{fontSize: '3rem'}}><FontAwesomeIcon icon={['fab', 'react']} /><span>&nbsp;<FontAwesomeIcon icon={['fab', 'node-js']} /></span><span>&nbsp;<FontAwesomeIcon icon={['fab', 'docker']} /></span></h1>
